select distinct
	...
	count(*),
	avg(qr.energy) as 'qa hybrid_energy',
...
inner join sa_results sr on qrs.run_configs_id = sr.run_configs_id
				and qrs.iteration_id = sr.iteration_id
				and qrs.cluster_id = sr.cluster_id
inner join tabu_results tr on qrs.run_configs_id = tr.run_configs_id
...
where qr.comp_type = 'hybrid' and n_filtered_vehicles <=500
